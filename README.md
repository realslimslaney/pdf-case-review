...
**Version 0.5.2** <!-- x-release-please-version -->, published on the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=realslimslaney.pdf-case-review). Documentation lives at [realslimslaney.github.io/pdf-case-review](https://realslimslaney.github.io/pdf-case-review/); the architecture decisions and spike results are in `docs/explanation/decisions.md`.
