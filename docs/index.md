# PDF Case Review documentation

Organized by the [diataxis](https://diataxis.fr/) framework:

- Tutorials: learning-oriented: [set up your computer](tutorials/setup.md) if VS Code is new to you,
  then [your first case](tutorials/first-case.md), start to report.
- How-to guides: task-oriented: [set up categories](how-to/categories.md),
...
- Explanation: why things are the way they are: [architecture decisions](explanation/decisions.md)
  (the ADRs and the spike log) and
  [how Claude Code and Codex know who you are](explanation/claude-accounts.md).
